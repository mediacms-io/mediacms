...
from .scheduling import SCHEDULE_OPTIONS, parse_scheduled_at, scheduled_at_text
...
class MigrationServiceSerializer(serializers.ModelSerializer):
    ...
    def validate(self, attrs):
        ...
        if options is not None:
            ...
            unknown = sorted(set(options) - set(klass.default_options) - retired - set(SCHEDULE_OPTIONS))
            if unknown:
