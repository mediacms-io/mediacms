...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('files', '0004_alter_subtitle_options_category_is_rbac_category'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('social_app', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='rbac_groups', to='socialaccount.socialapp')),
            ],
            options={
        ...
        migrations.AlterUniqueTogether(
            name='rbacgroup',
            unique_together={('name', 'social_app'), ('uid', 'social_app')},
        ),
    ]
