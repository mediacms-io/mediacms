...
function getArrayType(
  sourcesArr?: Array<{ [key: string]: string }>,
  pageArr: Array<{ [key: string]: string }> = []
...
function formatPagesConfig(
  sources: { title: string; filename: string; render: string; html: ConfigHtml; window: ConfigWindow },
  pages: ConfigPages
): ConfigPages {
