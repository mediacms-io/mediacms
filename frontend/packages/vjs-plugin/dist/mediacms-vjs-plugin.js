(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined'
    ...
    : ((global = typeof globalThis !== 'undefined' ? globalThis : global || self),
      (global['mediacms-vjs-plugin'] = factory()));
})(this, function () {
  'use strict';
  ...
  function generatePlugin() {
    ...
    var __SettingsMenuItemComponent__ = videojsComposeAndExtendCustomComp(
            ...
            if (args.playbackSpeeds.hasOwnProperty(k)) {
              ...
              (function (key, title) {
                ...
                tmp.methods.constructor = function () {
                  ...
                  pluginInstanceRef.on(this.player_, ['updatedSelectedPlaybackSpeed'], function () {
                    videojs.dom[
                      that.playbackSpeedKey === this.state.theSelectedPlaybackSpeed ? 'addClass' : 'removeClass'
    ...
    var MediaCmsVjsPlugin = (function (_VideojsPluginClass) {
      ...
      function MediaCmsVjsPlugin(
        ...
        _this.previousButtonClickCallback =
        ...
        if (_this.state.theSelectedQuality) {
          ...
          _this.videoFormat = extractSupportedAndUsedVideoFormat(
            _this.player.src(),
            _this.state.theSelectedQuality,
            _this.videoResolutions
          );
          ...
          value: function updateVideoElementPosition() {
            if (this.videoHtmlElem) {
              if (this.videoNativeDimensions) {
                var newval = centralizeBoxPosition(
