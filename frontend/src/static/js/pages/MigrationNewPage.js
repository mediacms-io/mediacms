...
const SOURCES = [
  ...
  },
  {
    ...
    label: 'Panopto',
    available: true,
    description: 'Import recordings, their owners and their folders from a Panopto instance.',
  },
  {
    id: 'youtube',
    label: 'YouTube',
    available: true,
    description: 'Import video, captions and metadata from YouTube urls, playlists or a channel.',
  },
];
