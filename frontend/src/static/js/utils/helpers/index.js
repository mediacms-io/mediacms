...
export { getParentMediaBase, inEmbeddedApp, inSelectMediaEmbedMode, isDeepLinkSelection, isSelectMediaMode, isShareMediaDisabled, submitDeepLinkSelection } from './embeddedApp';
